        ...
        <div className="max-w-4xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <nav className="hidden md:flex space-x-6 text-sm font-medium text-slate-600 items-center">
              <a href="/" className="hover:text-amber-700 transition-colors">장기요양계산기</a>
              <a href="/mission" className="hover:text-amber-700 transition-colors">자녀효도퀘스트</a>
              <a href="/os" className="hover:text-amber-700 transition-colors">가족돌봄OS</a>
